...
def CreateMesh(R,nm,nd,lambda0,n,x1,y1,x2,y2,x3,y3,x4,y4):
    ...
    #gmsh.model.setPhysicalGroupe(1,)

    gmsh.model.occ.synchronize()
    
    gmsh.model.addPhysicalGroup(1,[circle],tag=16)
    gmsh.model.addPhysicalGroup(1,[line1,line2,line3,line4],tag=19)
...
def GetData(R,nm,nd,lambda0,n,x1,y1,x2,y2,x3,y3,x4,y4):
    ...
    # gmsh.option.setNumber("General.Verbosity", 2)
    mesh = meshio.read("C:/Users/PC/Desktop/cours/ProjetL3/Meshes/{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}.msh".format(R,nm,nd,lambda0,n,x1,y1,x2,y2,x3,y3,x4,y4))
