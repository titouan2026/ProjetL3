...
def CreateMesh(L,l,nm,nd,lambda0,n):
    ...
    point1 = gmsh.model.occ.add_point(0.1*L, l, 0, lc/n)
    point2 = gmsh.model.occ.add_point(0.1*L, -l, 0, lc/n)
    point3 = gmsh.model.occ.add_point(-0.1*L, -l, 0, lc/n)
    point4 = gmsh.model.occ.add_point(-0.1*L, l, 0, lc/n)
    
    point5 = gmsh.model.occ.add_point(L, l, 0, lc/n)
    point6 = gmsh.model.occ.add_point(L, -l, 0, lc/n)
    point7 = gmsh.model.occ.add_point(-L, -l, 0, lc/n)
    point8 = gmsh.model.occ.add_point(-L, l, 0, lc/n)
